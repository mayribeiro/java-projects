...
import br.com.metodo.criacao.constructor.Estrategia;
...
public class Emprestimo {
	...
	private Emprestimo(Estrategia estrategia, double obrigacao, double paraSaldar, int escalaDeRisco, Date vencimento,
			Date expiracao) {
